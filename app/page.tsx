        ...
        <section id="Home">
          <div className="flex flex-col gap-4 h-full md:flex-row">
            <div className="flex rounded-xl flex-col justify-center order-2 md:order-1 gap-4 bg-gray-50 px-6 py-10 md:w-1/2 md:px-12">
              ...
              <p className='md:text-lg'>I'm a <strong>Software Quality Engineer</strong> currently based in Lake Tahoe. I love diving into complex challenges and improving both product and customer experiences. My goal is to continue honing my technical prowess while delivering software solutions that people love.
              </p>
